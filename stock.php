...
if (isset($_POST['update'])) {
    ...
    $updatedata = mysqli_query($conn, "insert into sstock_brg set nama='$nama', jenis='$jenis', merk='$merk', harga='$harga', satuan='$satuan', lokasi='$lokasi' where idx='$idx'");
    ...
    if ($updatedata) {
        ...
        echo "<div class='alert alert-warning'>
                <strong>Failed!</strong> Harap tunggu loading page.
              </div>
             <meta http-equiv='refresh' content='1; url= stock.php'/> ";
    }
};
                ...
                <div class="row align-items-center">
                    ...
                    <div class="col-md-6 col-sm-8 clearfix">
                        ...
                        <div class="search-box pull-left">
                            <form action="#">
                                <h2>Hi, Selamat Datang di Input Stock Barang Toko Yayuk</h2>
                            </form>
                        </div>
                    </div>
                                        ...
                                        <tbody>
                                            ...
                                            ?>
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <button data-toggle="modal" data-target="#edit<?= $idb; ?>" class="btn btn-warning">Ubah</button>
                                                        ...
                                                        <div class="modal-content">
                                                            <form method="post">
                                                                ...
                                                                <div class="modal-header">
                                                                    <h4 class="modal-title">Edit Barang <?php echo $p['nama'] ?> - <?php echo $p['jenis'] ?> - <?php echo "Rp. " . number_format($p['harga'], 0, ",", ".") ?></h4>
                                                                ...
                                                                <div class="modal-body">
                                                                    ...
                                                                    <input type="text" id="harga" name="harga" class="form-control" value="<?php echo "Rp. " . number_format($p['harga'], 0, ",", ".") ?>">
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form action="tmb_brg_act.php" method="post">
                        ...
                        <div class="form-group">
                            <label>Stock</label>
                            <input name="stock" type="number" min="0" class="form-control" placeholder="Jumlah Stock">
                        </div>
                        <div class="form-group">
                            <label>Satuan</label>
